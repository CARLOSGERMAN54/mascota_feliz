...
<body>
		...
		<nav class="navegacion">
			<ul class="menu" >
				...
				<li class="item-submenu" menu="2">
					<a href="#"><span class="fa fa-shopping-bag icon-menu"></span>Mascotas</a>
					<ul class="submenu">
						<li class="title-menu"><span class="fa fa-shopping-bag icon-menu"></span>Mascotas</li>
						<li class="go-back">Atras</li>
	...
	<main class="contenedor">dasdasd</main>
</body>
</html>